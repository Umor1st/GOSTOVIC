...
@gostbot.message_handler(commands=["Начать_Journal-2003"])
...
def journal_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Journal-2003`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear() 

@gostbot.message_handler(commands=["Начать_Book-Normal-2003"])
...
def book_normal_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Book-Normal-2003`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Ethernet-2003"])
...
def result_eth_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Ethernet-2003`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear() 

@gostbot.message_handler(commands=["Начать_Dissertation-2003"])
...
def dissert_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Dissertation-2003`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Aftoreferat-2003"])
...
def aftoref_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Aftoreferat-2003`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()


@gostbot.message_handler(commands=["Начать_Zakon-2003_Document"])
...
def zakon_document_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`Начать_Zakon-2003_Document`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Zakon-2003_Federation"])
...
def zakon_federation_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Zakon-2003_Federation`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Zakon-2003_Federation_Internet"])
...
def zakon_federation_internet_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Zakon-2003_Federation_Internet`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()


@gostbot.message_handler(commands=["Начать_Zakon-2003_Postanovlenie"])
...
def zakon_postan_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Zakon-2003_Postanovlenie`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()



@gostbot.message_handler(commands=["Начать_Mnogotomnik-2003_toms"])
...
def book_mnogotomnic_toms_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Mnogotomnik-2003_toms`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Mnogotomnik-2003_chapters"])
...
def book_mnogotomnic_chapters_result_2003(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Mnogotomnik-2003_chapters`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

# 2008 год 
# Handler для работы с журналом ГОСТ-а 2008 года
@gostbot.message_handler(commands=["Начать_Journal-2008"])
...
def journal_result_2008(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Journal-2008`", parse_mode="MarkdownV2")
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Book-Normal-2008"])
...
def book_normal_result_2008(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Book-Normal-2008`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Book-EBC-2008"])
...
def book_EBC_result_2008(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Book-EBC-2008`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Ethernet-2008"])
...
def result_eth_2008(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Ethernet-2008`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear() 

@gostbot.message_handler(commands=["Начать_Dissertation-2008"])
...
def dissert_result_2008(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Dissertation-2008`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Aftoreferat-2008"])
...
def aftoref_result_2008(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Aftoreferat-2008`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Mnogotomnik-2008"])
...
def book_mnogotomnic_toms_result_2008(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Mnogotomnik-2008`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

# 2018 год 
# Handler для работы с журналом ГОСТ-а 2018 года
@gostbot.message_handler(commands=["Начать_Journal-2018"])
...
def journal_result_2018(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Journal-2018`", parse_mode="MarkdownV2")
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Book-Normal-2018"])
...
def book_normal_result_2018(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Book-Normal-2018`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Ethernet-2018"])
...
def result_eth_2018(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Ethernet-2018`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear() 

@gostbot.message_handler(commands=["Начать_Dissertation-2018"])
...
def dissert_result_2018(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Dissertation-2018`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Aftoreferat-2018"])
...
def aftoref_result_2018(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Aftoreferat-2018`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()

@gostbot.message_handler(commands=["Начать_Mnogotomnik-2018"])
...
def book_mnogotomnic_toms_result_2018(message):
    ...
    gostbot.send_message(id_chat, f"Твой ГОСТ готов \!\n`{result}`", parse_mode="MarkdownV2")
    gostbot.send_message(id_chat, f"Чтобы воспользоваться этим оформлением снова введите:\n`/Начать_Mnogotomnik-2018`", parse_mode="MarkdownV2",reply_markup=back())
    print(result)
    gost_dict[id_chat].clear()
