...
def callback_query(call):
    ...
    gostbot.edit_message_text("Выберите год:", id_chat, message_id)
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=markup_years())
...
# Callback возращает виды литературы для, ГОСТ 2003 года
@gostbot.callback_query_handler(func=lambda call: call.data == "2003")
def callback_query(call):
    id_chat = call.message.chat.id
    message_id = call.message.message_id
    backlist.append(["Выберите год:", markup_years()])
    gostbot.edit_message_text("Материалы для ГОСТ 2003 года", id_chat, message_id)
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=markup_2003())   
    
# Callback возращает виды литературы для 2008 года
@gostbot.callback_query_handler(func=lambda call: call.data == "2008")
def callback_query(call):
    id_chat = call.message.chat.id
    message_id = call.message.message_id
    backlist.append(["Выберите год:", markup_years()])
    gostbot.edit_message_text("Материалы для ГОСТ 2008 года", id_chat, message_id)
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=markup_2008())


# Callback возращает виды литературы для 2018 года
@gostbot.callback_query_handler(func=lambda call: call.data == "2018")
def callback_query(call):
    id_chat = call.message.chat.id
    message_id = call.message.message_id
    backlist.append(["Выберите год:", markup_years()])
    gostbot.edit_message_text("Материалы для ГОСТ 2018 года", id_chat, message_id)
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /Journal2003", id_chat, message_id, parse_mode="MarkdownV2")
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /BookNormal2003", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2003 года", markup_2003()])
    gostbot.edit_message_text("Отправьте: /Ethernet2003", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2003 года", markup_2003()])
    gostbot.edit_message_text("Отправьте: /Dissertation2003", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2003 года", markup_2003()])
    gostbot.edit_message_text("Отправьте: /Aftoreferat2003", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /Zakon2003Document", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Выберите один из предложенных законодательных материалов", zakon_2003()])
    gostbot.edit_message_text("Отправьте: /Zakon2003Federation", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Выберите один из предложенных законодательных материалов", zakon_2003()])
    gostbot.edit_message_text("Отправьте: /Zakon2003FederationInternet", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Выберите один из предложенных законодательных материалов", zakon_2003()])
    gostbot.edit_message_text("Отправьте: /Zakon2003Postanovlenie", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /Mnogotomnik2003toms", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /Mnogotomnik2003chapters", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    gostbot.edit_message_text(f"Отправьте: /Journal2008", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /BookNormal2008", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Выберите одно оформление книги:", book_2008()])
    gostbot.edit_message_text("Отправьте: /BookEBC2008", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2008 года", markup_2008()])
    gostbot.edit_message_text("Отправьте: /Ethernet2008", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2008 года", markup_2008()])
    gostbot.edit_message_text("Отправьте: /Dissertation2008", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2008 года", markup_2008()])
    gostbot.edit_message_text("Отправьте: /Aftoreferat2008", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2008 года", markup_2008()])
    gostbot.edit_message_text("Отправьте: /Mnogotomnik2008", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /Journal2018", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /BookNormal2018", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Выберите одно оформление книги:", book_2018()])
    gostbot.edit_message_text("Отправьте: /BookEBC2018", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    gostbot.edit_message_text("Отправьте: /Ethernet2018", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2018 года", markup_2018()])
    gostbot.edit_message_text("Отправьте: /Dissertation2018", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2018 года", markup_2018()])
    gostbot.edit_message_text("Отправьте: /Aftoreferat2018", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
...
def callback_query(call):
    ...
    message_id = call.message.message_id
    backlist.append(["Материалы для ГОСТ 2008 года", markup_2008()])
    gostbot.edit_message_text("Отправьте: /Mnogotomnik2018", id_chat, message_id, parse_mode="MarkdownV2")
    gostbot.edit_message_reply_markup(id_chat, message_id, reply_markup=back())
